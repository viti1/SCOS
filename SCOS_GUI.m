...
%      SCOS_GUI, by itself, creates a new SCOS_GUI or raises the existing
%      singleton*.
%
%      H = SCOS_GUI returns the handle to a new SCOS_GUI or the handle to
%      the existing singleton*.
%
%      SCOS_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SCOS_GUI.M with the given input arguments.
%
%      SCOS_GUI('Property','Value',...) creates a new SCOS_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SCOS_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SCOS_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SCOS_GUI

% Last Modified by GUIDE v2.5 13-Sep-2023 17:33:05
...
% --- Executes on button press in btn_UpdateFolder.
function btn_UpdateFolder_Callback(hObject, eventdata, handles)
% hObject    handle to btn_UpdateFolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% Hint: place code in OpeningFcn to populate ax_image
