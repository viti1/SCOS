...
testsFolder = [ testsFoldersList.local filesep 'ReadRecord' ];

% Create ReadRecord test Cases
recName1 = 'AviSingleFile_f25mm_Tint3ms_Gain0_FR100Hz';
...
cases(n).output = run_ReadRecord(cases(n).input, testsFolder);
n = n + 1 ;
...
save(fullfile(testsFolder,'testScenatios_ReadRecord.mat'),'cases');
